...
const LocationZoneIcon = ({size, height, width, color, style, className}: LocationZoneIconProps) => {
  const sizeValue: string = typeof size === "number" ? `${size}px` : '';
  return (
    <svg
      viewBox="0 0 498.881 498.881"
    ...
    >
      <path
        d="M231.41,148.209h47.265v53.138h31.191V22.369C309.866,10.016,299.859,0,287.506,0H66.765

...
export const PlusIcon = ({size, height, width, color, style, className}: PlusIconProps) => {
  return (
    <svg
      viewBox="0 -0.5 21 21"
      ...
      className={className}
    >
    <g id="Page-1" stroke="none" strokeWidth="1" fill={color || "currentColor"} fillRule="evenodd">
      <g id="Dribbble-Light-Preview" transform="translate(-419.000000, -520.000000)" fill="currentColor">

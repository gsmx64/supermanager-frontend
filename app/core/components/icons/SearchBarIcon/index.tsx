import type { SearchBarIconProps } from "@/core/components/icons/SearchBarIcon/types/SearchBarIcon.type";


const SearchBarIcon  = ({size, height, width, color, style, className}: SearchBarIconProps) => {
  ...
  return (
    <svg
      ...
      style={style}
      className={className ? className : "fill-current w-6 h-6"}
    >
      <path
        d="M302.188,279.563C313.36,263.875,320,244.727,320,224c0-53.032-42.984-96-96-96c-53.017,0-96,42.968-96,96

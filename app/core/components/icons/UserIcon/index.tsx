import type { UserIconProps } from "@/core/components/icons/UserIcon/types/UserIcon.type";


const UserIcon  = ({size, height, width, style, className}: UserIconProps) => {
  return (
    <svg
      viewBox="-0.5 0 33 33"

import type { DashboardIconProps } from "@/core/components/icons/DashboardIcon/types/DashboardIcon.type";


const DashboardIcon  = ({size, height, width, color, style, className}: DashboardIconProps) => {
  return (
    <svg
      viewBox="0 0 24 24"
